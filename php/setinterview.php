    ...
    <div class="col-lg-9">
          <div class="card mb-4" >
            <div class="card-body">
                    ...
                    <form class="sign-in pt-4 " method="post" action="../includes/inerview-inc.php">
                       <img src="../img/inter.jpg" style="width:150px">
    
                    <div class="form-outline" style=" height: 44px;margin-top:3%;  ">
                            <div><label style="font-weight: bolder; margin-bottom:1%;">choose an interview date </label>
                            </div>
                            <input type="date" id="typeNumber" class="form-control" name="interview"
                                style="width: 309px;  display: block !important;  border: 1px solid #bdbdbd;" value=<?php echo date("Y-m-d");  ?> required>
                        </div>
                       
                            
                        
                            <div><button type="submit" class="btn btn-primary btn-lg  rounded-pill" name="submit"
                        style="margin-top:50px;">SET</button></div>
