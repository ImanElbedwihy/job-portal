...
<head>
  ...
  <title>interns applications</title>
  <!-- MDB icon -->
 ...
 <div class="col">
          <div class="card mb-4">
            <div class="card-body">
              ...
              <form class="sign-in pt-4 " method="post" action="../includes/deleteintern-inc.php" style=" margin-top: -4%;">


<?php
      $sql = "SELECT * FROM applyforintern ,company ,intern where JobSeekerUserName=? and internID=id  and UserName= CompanyUserName ";
      $stmt = mysqli_stmt_init($conn);
  ...
  {
    echo "<b>You didn't apply for any internships yet</b> ";
