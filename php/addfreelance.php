    ...
    <div class="col-lg-9">
          <div class="card mb-4" >
            <div class="card-body">
                    ...
                    <form class="sign-in pt-4 " method="post" action="../includes/addfreelance-inc.php"
                        style=" margin-top: -4%;">
                        <div class="form-floating ">
                            <div><label style="font-weight: bolder;">Task (Brief description of what is required) </label></div>
                            <textarea id="floatingInput"
                                style="width: 309px;  height:150px;;margin-bottom:3%;" name="task"rows="5"  cols="40"required></textarea>

                        </div>
                        <div class="form-floating ">
                            <div><label style="font-weight: bolder;">Field </label></div>
                            <input type="text" class="form-control" id="floatingInput"
                                style="width: 309px;  height:45px;margin-bottom:3%;" name="field" required>
