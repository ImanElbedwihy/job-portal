...
$sql = "SELECT * FROM job where CompanyUserName=?  ";
...
if (!mysqli_stmt_prepare($stmt, $sql)) {
    ...
    exit();
       ...
       mysqli_stmt_bind_param($stmt,"s", $_SESSION['company'] );
...
$sql = "SELECT * FROM intern where CompanyUserName=?  ";
$stmt = mysqli_stmt_init($conn);
...
$sql = "SELECT * FROM freelance where CompanyUserName=?  ";
$stmt = mysqli_stmt_init($conn);
...
$sql = "SELECT * FROM applyforintern,intern where IsAccepted=1 and  internID=id and CompanyUserName=?  ";
$stmt = mysqli_stmt_init($conn);
...
$sql = "SELECT * FROM applyforjob,job where IsAccepted=1  and JobId=id and CompanyUserName=?";
$stmt = mysqli_stmt_init($conn);
...
$sql = "SELECT * FROM applyforfreelance,freelance where IsAccepted=1   and freelanceID=id and CompanyUserName=?";
$stmt = mysqli_stmt_init($conn);
...
<div class="container">
    ...
    <div class="col-md-3">
      <div class="card-counter primary">
       <i class="fa-solid fa-briefcase"></i>
        <span class="count-numbers"><?php echo $job ?></span>
    ...
    <div class="col-md-3">
     ...
     <i class="fa-solid fa-chalkboard-user"></i>
        <span class="count-numbers"><?php echo $intern ?></span>
        <span class="count-name">internships</span>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card-counter success">
       <i class="fa-solid fa-laptop"></i>
        <span class="count-numbers"><?php echo $free ?></span>
        <span class="count-name">freelances</span>
      </div>
    </div>
