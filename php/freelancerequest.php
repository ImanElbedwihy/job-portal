...
if (isset($_SESSION['sessionUser'])&& $_SESSION['type']==2&& isset( $_SESSION['freeid']) ){
...
$sql = "select * from applyforfreelance,jobseeker,freelance where freelanceID =? and freelanceID =id  and JobSeekerUserName=UserName and IsAccepted=0";
...
if (!mysqli_stmt_prepare($stmt, $sql)) {
    ...
    mysqli_stmt_bind_param($stmt, "i", $_SESSION['freeid']);
                        ...
                        if (mysqli_num_rows($res) > 0)
   {
    ...
    
    {
          ...
          echo $row['Fname'];
                                echo "&nbsp;";
                                echo $row['Lname'];
                                echo " has applied for this task";
                                echo " in ";
                                echo $row['date'];
                                ...
                                echo "<button type='submit' class='btn btn-primary  rounded-pill' name='submitl'
                                style='margin-top:1%; margin-right:4%;'  value='$u'>accept</button>";
                                echo "<button type='submit' class='btn btn-primary  rounded-pill' name='submip'
