...
<div class="col-lg-9">
   ...
   " name="job">
            ...
            <button type="submit" class="btn btn-primary btn-lg  rounded-pill" name="submit1">Delete</button>
   ...
   " name="intern">
        ...
        <button type="submit" class="btn btn-primary btn-lg  rounded-pill" name="submit2">Delete</button>
        ...
        <table style="   border: 1px solid black; width:100%">
          <tr>
            ...
            <th style="text-align:center; border: 1px solid;">deadline</th>
   ...
   " name="free">
        ...
        <button type="submit" class="btn btn-primary btn-lg  rounded-pill" name="submit3">Delete</button>
        <?php
          }
                    ?>
        </form>
