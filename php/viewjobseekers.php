...
require_once '../includes/database.php';
  ...
  exit();
    ...
    $sql = "SELECT * FROM jobseeker,user WHERE jobseeker.UserName=user.UserName ";
...
<input type="text" placeholder="Search by last or first name " name="search" style=   " width: 80%;
margin-bottom: 0.5%;" >
...
if($row['field']&&$row['field']!=" ")
                     ...
                     style='margin-top:1%;margin-right:4%' value='$username' >Delete  </button>

                     <button type='submit' class='btn btn-primary   rounded-pill' name='submit1'
                     style='margin-top:1%;' value='$username' >View Feedbacks  </button>
                     
                     </div>";

                      echo "</div>";
                  }
              } else { echo "<div><img src='../img/notfound.jpg'></div>";
              }?>
              </form>
            </div>
