    ...
    <div class="col-lg-9">
          <div class="card mb-4" >
            <div class="card-body">
                    ...
                    <form class="sign-in pt-4 " method="post" action="../includes/feedback-inc.php">
                       <img src="../img/feed.png" style="width:150px" >
    
                    <div class="form-outline" style="margin-top:3%; ">
                            <div><label style="font-weight: bolder; margin-bottom:1%;">Send feedback</label>
                            </div>
                            <div>
                            <textarea id="floatingInput" 
                            style="width: 309px;  height:150px;;margin-bottom:3%;" name="feed"rows="5"  cols="40"required></textarea>
</div>
                        </div>
