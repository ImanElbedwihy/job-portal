    ...
    if ($_SESSION['sessionpassword'] == $_POST['oldpassword']) {
        ...
        if ($_POST['newpassword'] == $_POST['confirmPassword']) {
            ...
            if (!mysqli_stmt_prepare($stmt, $sql)) {
                header("Location: ../php/adminchangepassword.php?error=sqlerror");
                exit();
            } else {
                ...
                header("Location: ../php/adminchangepassword.php?success=saved");
            ...
            header("Location: ../php/adminchangepassword.php?confiromnotequalnew");
            exit();
        }
    } else {
        //  echo ("wrong password");
        header("Location: ../php/adminchangepassword.php?error=oldpasswordnotcorrect");
        exit();
